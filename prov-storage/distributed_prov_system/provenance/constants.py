#file added in https://gitlab.ics.muni.cz/422328/dbprov
...
# added constants for backward and forward connectors attributes for this thesis
BACKWARDS_CONNECTOR_MANDATORY_ATTRIBUTES = (
CPM_REFERENCED_BUNDLE_ID, CPM_REFERENCED_META_BUNDLE_ID,
CPM_REFERENCED_BUNDLE_HASH_VALUE, CPM_HASH_ALG)
