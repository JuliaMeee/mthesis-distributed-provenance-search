...
from provenance.prov_validators.prov_check.provconstraints import validate
...
class ProvValidatorExternal(ProvValidator):
    ...
    def is_valid(self, document: ProvDocument):
        ...
        with open("temp_doc_to_validate.rdf", "w+b") as rdf_file:
            ...
            serializer.serialize(rdf_file, rdf_format="turtle") # serialization seems nok sometimes
