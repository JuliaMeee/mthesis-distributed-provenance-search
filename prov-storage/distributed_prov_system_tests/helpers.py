...
from provenance.constants import CPM_MAIN_ACTIVITY, CPM_REFERENCED_META_BUNDLE_ID, DCT_HAS_PART, CPM_FORWARD_CONNECTOR, \
...
class ExistentialVariablesGenerator:
    """Class for generating existential variable identifiers - for creating provenance in normal form
    """
    def __init__(self, existential_variable_prefix):
        """Registers organization to storage service

        :param existential_variable_prefix: prefix of created identifiers
...
def create_normalized_graph(existential_variable_prefix):
    """Creates domain part of cpm component

    :param existential_variable_prefix: prefix of existential identifiers
    :returns: entity identifier
    """
...
def create_main_act_attributes(storage_name):
    """Creates main activity attributes with different meta bundle identifiers in same meta provenance namespace

    :param storage_name: name of storage - meta namespace creatred according to it
    :returns: main_activity_attributes_ok, main_act_attr2, timestamp: main activity attributes twice, timestamp of their creation
    """
    meta_ns = Namespace(
...
def prepare_attributes_for_doc_w_backward_connectors(prev_cpm_bundle_info, prev_meta_bundle_info, timestamp):
    """Creates bundle and document for component with backward connector,
     prepares attributes for backward connector

    :param prev_cpm_bundle_info: information about component to be referenced from backward connector
    :param prev_meta_bundle_info: information about meta component to be referenced from backward connector
    :param timestamp: timestamp of document creation - for identifier
    :returns: bundle_with_backwards_conn, document_with_backwards_connector, backward_connector_attributes, remote_meta_bundle - created bundle,
    """
    ...
    remote_bundle = bundle_with_backwards_conn.add_namespace("remote_bundle", prev_cpm_bundle_info[0])
    remote_meta_bundle = bundle_with_backwards_conn.add_namespace(
...
def create_domain_prov_smaller(bundle, existential_variable_generator, org_prefix):
    """Creates domain provenance and adds it to bundle provided

    :param bundle: bundle to which the domain provenance should be added
    :param existential_variable_generator: generator for identifiers that are not important
    :param org_prefix: organization namespace identifier to create entities belonging to organization
    :returns: None
    """
...
def create_domain_prov(bundle, existential_variable_generator, org_prefix):
    """Creates domain provenance and adds it to bundle provided, slightly bigger domain provenance created here
...
def create_cpm_provenance_basic(existential_prefix, storage_name, org_name, timestamp, main_activity_attributes,
    ...
    """Creates provenance component with no specific connector, only general forward connector

    :param existential_prefix: prefix to be used when creating existential ids
    :param storage_name: name of prov storage service
    :param org_name: name of organization registered in prov storage service that is saving the component
    :param timestamp: timestamp of current test - id of component depends on it
    :param main_activity_attributes: attributes of main activity
    :param forward_connector_attributes: attributes of forward connector
    :param bundle_suffix: suffix of bundle identifier
    :param smaller_prov: true if smaller domain provenance should be created
    :returns: document: document created
    :returns: bundle: bundle created
    :returns: meta_bundle_id: meta bundle identifier of created bundle
    :returns: backbone_parts: records from this component belonging to traversal information
    :returns: [bundle.identifier.namespace.uri, bundle.identifier.localpart, hash_doc]: information about created component for future connectors
    :returns: existential_variable_generator
    """
    document = ProvDocument()
    ...
    if smaller_prov:
        create_domain_prov_smaller(bundle,
...
def create_main_activity(bundle, domain_activities, main_activity_attributes,
    ...
    """Adds main activity to bundle

    :param bundle: bundle to add main activity to
    :param domain_activities: domain activities
    :param main_activity_attributes: attributes to assign to main activity
    :param storage_name: name of storage - identifier created according to it
    :param start_time: start time of main activity
    :param end_time: end time  of main activity
    :returns: main_activity: created main activity
    """
...
def add_general_forward_connector(bundle, main_activity, sample_forward_connector,
    ...
    """Adds general forward connector to bundle

    :param bundle: bundle to add forward connector to - represents CPM component
    :param main_activity: main activity of cpm component
    :param sample_forward_connector: attributes to assign to main activity
    :param to_connect: identifier of entity from domain part that the forward connector represents
    :param backbone_parts: traversal information relations - to add what is created in function to them
    :param add_generation_from_main_activity: true if forward connector should be generated by main activity, else it is derived from other connector
    :param prev_connector: previous connector - should be specified if add_generation_from_main_activity is false
    :returns: None
    """
...
def create_cpm_provenance_basic_without_fw_connector(existential_prefix, storage_name, org_name, timestamp,
                                                     ...
                                                     bundle_suffix="", smaller_prov=False):
    """Creates provenance component with no conector
...
def create_cpm_provenance_basic_without_fw_connector_with_two_bw_connectors \
    ...
    """Creates provenance component with no forward connector and two backward connectors
    :param document: document to add provenance to
    :param bundle: bunde to add provenance to
    :param existential_prefix: prefix to be used when creating existential ids
    :param storage_name: name of storage where component will be saved
    :param main_activity_attributes: attributes of main activity
    :param sender_org_name_1: name of organization referenced from first backward connector
    :param backward_connector_attributes_1: first backward connector attributes
    :param sender_org_name_2: name of organization referenced from second backward connector
    :param backward_connector_attributes_2: second backward connector attributes
    :returns: document: document created
    :returns: bundle: bundle created
    :returns: meta_bundle_id: meta bundle identifier of created bundle
    :returns: backbone_parts: records from this component belonging to traversal information
...
def create_cpm_provenance_with_backward_connector(document, bundle, existential_prefix,
    ...
    """Creates provenance component with one backward connector and optionally specific forward connector
    :param document: document to add provenance to
    :param bundle: bundle to add provenance to - may have different identifier each time, so it is passes to this function
    :param existential_prefix: prefix to be used when creating existential ids
    :param prev_cpm_bundle_info: information about component to be referenced from backward connector
    :param prev_meta_bundle_info: information about meta component to be referenced from backward connector
    :param main_activity_attributes: attributes of main activity
    :param sender_org_name: name of organization referenced from backward connector
    :param backward_connector_attributes: backward connector attributes
    :param forward_connector_attributes: attributes of forward connector
    :param add_forward_connector_param: true if specific forward connector should be added
    :param receiver_org_name: name of organization referenced from specific forward connector
    :returns: document: document created
    :returns: backbone_parts: records from this component belonging to traversal information
    :returns: meta_bundle_id: meta bundle identifier of created bundle
    :returns: [bundle.identifier.namespace.uri, bundle.identifier.localpart, hash_doc]: information about created component for future connectors
...
def add_forward_connector(backbone_parts, bundle,
    ...
    """Adds a specific forward connectors connections and records to a bundle

    :param backbone_parts: list of records from traversal information
    :param bundle: bundle to add connector to
    :param receiver_org_name: name of receiver referenced by forward connector
    :param sample_concrete_forward_connector: specific forward connector
    :param sample_forward_connector: general forward connector
    :param to_connect: id of entity connected to forward connector
    :returns: receiver_agent: created receiver agent
    """
...
def add_backward_connector(backward_connector_attributes, bundle, main_activity,
    ...
    """Creates a backward connector and adds it to bundle, also creates corresponding relations

    :param backward_connector_attributes: attributes of backward connector
    :param bundle: bundle to add connector to
    :param main_activity: name main activity from the bundle
    :param sender_org_name: name of senders organization
    :param remote_bundle_namespace: namespace that should be used for connectors identifier
    :param to_connect: id of entity connected to forward connector
    :param backbone_parts: list of records from traversal information
    :param with_usage: true if main activity uses this connector, otherwise other connector has to be derived from one created here elsewhere
    :returns: sample_backward_connector: created connector
    """
...
def create_cpm_with_forward_connector(existential_prefix, storage_name, org_name, timestamp, main_activity_attributes,
    ...
    :param existential_prefix: prefix to be used when creating existential ids
    :param storage_name: name of prov storage service that component should be saved to
    :param org_name: name of organization registered in prov storage service that is saving the component
    :param timestamp: timestamp of document creation - for identifier
    :param main_activity_attributes: attributes of main activity
    :param receiver_org_name: name of organization referenced from specific forward connector
    :param forward_connector_attributes: attributes of forward connector
    :param bundle_suffix: suffix of bundle identifier
    :param add_second_forward_connector: true if redundant connector should be added
    :param second_forward_connector_attributes: attributes of redundant forward connector
    :param second_receiver_org_name: name of organization referenced from second specific forward connector
    :returns: document: document created
    :returns: bundle: bundle created
    :returns: meta_bundle_id: meta bundle identifier of created bundle
    :returns: backbone_parts: records from this component belonging to traversal information
...
def create_prov_cpm_basic_and_prepare_bundle_referencing_it_with_backward_connector():
    """Creates basic provenance component, gets info for creating backward connector from it, prepares bundle for
    creating component with backward connector and connectors attributes

    :returns: backward_connector_attributes: attributes of backward connector
    :returns: bundle_with_backwards_conn: bundle that the connector should be added to
    :returns: document_with_backwards_connector: bundle that the connector should be added to
    :returns: maa2: main activity attributes to be used in bundle with backward connector
    :returns: prev_cpm_bundle_info: information about component to be referenced from backward connector
    :returns: prev_meta_bundle_info: information about meta component to be referenced from backward connector
    :returns: remote_meta_bundle: namespace of meta bundle of backward connector
    """

    storage_name = "pathology"
    org_name = "org"
    ...
    (bundle_with_backwards_conn, document_with_backwards_connector,
     backward_connector_attributes, remote_meta_bundle_ns) = prepare_attributes_for_doc_w_backward_connectors(
        prev_cpm_bundle_info,
        prev_meta_bundle_info,
        timestamp)
    return (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector, maa2, prev_cpm_bundle_info,
            prev_meta_bundle_info, remote_meta_bundle_ns)
