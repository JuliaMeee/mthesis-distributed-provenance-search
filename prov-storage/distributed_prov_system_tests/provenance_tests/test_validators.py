...
from provenance.prov_doc_validators_strategies import ProvValidatorWithNormalization
...
class MyTestCase(TestCase):
    ...
    def test_is_org_registered_false_returns_false(self, MockDoesnotExist, MockOrgNodes):
        MockOrgNodes.get = MagicMock()
    ...
    @patch('neomodel.exceptions.DoesNotExist._model_class', return_value='c')
    @patch('provenance.models.Organization.nodes')
    def test_check_organization_is_registered_organization_does_not_exist_throws_exception(self, MockOrgNodes, MockDoesnotExist):
        MockOrgNodes.get = MagicMock()
        MockOrgNodes.get.return_value = None
        MockOrgNodes.get.side_effect = DoesNotExist("no")
    ...
    @patch('provenance.models.Organization.nodes')
    def test_check_organization_is_registered_trusted_party_of_org_not_checked_throws_exception(self, MockOrgNodes):
        org = Organization()
    ...
    @patch('provenance.models.Organization.nodes')
    def test_check_organization_is_registered_trusted_party_is_not_valid_throws_exception(self, MockOrgNodes):
        org = Organization()
        org.identifier = "org_id"
    ...
    @patch('provenance.models.Organization.nodes')
    def test_check_organization_is_registered_ok_does_not_throw_exception(self, MockOrgNodes):
        org = Organization()
        org.identifier = "org_id"
    ...
    def test_graph_exists_ok_returns_true(self, MockDocNodes):
    ...
    @patch('neomodel.exceptions.DoesNotExist._model_class', return_value='c')
    @patch('provenance.models.Document.nodes')
    def test_graph_exists_not_exists_returns_false(self, MockDocNodes, MockDoesnotExist):
        MockDocNodes.get = MagicMock()
    ...
    @patch('neomodel.exceptions.DoesNotExist._model_class', return_value='c')
    def test_check_graph_id_belongs_to_meta_meta_bundle_does_not_exist_throws_exception(self, MockDoesnotExist, MockBundleNodes,
    ...
    @patch('provenance.neomodel2prov.neomodel.Traversal')
    @patch('provenance.models.Bundle.nodes')
    def test_check_graph_id_belongs_to_meta_multiple_meta_bundles_throws_exception(self, MockBundleNodes,
                                                                  MockTraversal, MockEntityNodes):
        entity = MagicMock()
        entity.identifier = "entity_id"
    ...
    def test_check_graph_id_belongs_to_meta_multiple_meta_bundles_throws_exception(self, MockLength, MockBundleNodes,
                                                                  MockTraversal, MockEntityNodes):
        entity = MagicMock()
        entity.identifier = "entity_id"
        bundle = Bundle()
        ...
        MockTraversal.all.return_value = None
    ...
    @patch('provenance.models.Bundle.nodes')
    @patch('provenance.validators.len')
    def test_check_graph_id_belongs_to_meta_ok_no_exception(self, MockLength, MockBundleNodes,
                                                                  MockTraversal, MockEntityNodes):
        entity = MagicMock()
        entity.identifier = "entity_id"
        bundle = Bundle()
    ...
    @patch("requests.head")
    def test_parse_graph_InputChecker_parses_graph(self, MockRequest, MockContainsIp):
    ...
    @patch("provenance.validators.contains_my_ip_addr")
    @patch("requests.head")
    def test_parse_graph_no_main_activity_throws_exception(self, MockRequest, MockContainsIp):
        main_activity_attrs, _, _ = helpers.create_main_act_attributes("hospital")
        doc, bundle, _, _, _, _ = helpers.create_cpm_provenance_basic("ex", "hospital", "org",
                                                                      datetime.now().timestamp(), main_activity_attrs)
    ...
    @patch("provenance.validators.contains_my_ip_addr")
    @patch("requests.head")
    def test_parse_graph_wrong_ip_throws_exception(self, MockRequest, MockContainsIp):
        main_activity_attrs, _, _ = helpers.create_main_act_attributes("hospital")
        doc, bundle, _, _, _, _ = helpers.create_cpm_provenance_basic("ex", "hospital", "org",
                                                                      datetime.now().timestamp(), main_activity_attrs)
        data_b64 = base64.b64encode(doc.serialize().encode("utf-8"))
    ...
    @patch("provenance.validators.contains_my_ip_addr")
    @patch("requests.head")
    def test_parse_graph_wrong_url_throws_exception(self, MockRequest, MockContainsIp):
        main_activity_attrs, _, _ = helpers.create_main_act_attributes("hospital")
        doc, bundle, _, _, _, _ = helpers.create_cpm_provenance_basic("ex", "hospital", "org",
                                                                      datetime.now().timestamp(), main_activity_attrs)
        data_b64 = base64.b64encode(doc.serialize().encode("utf-8"))
    ...
    @patch("provenance.validators.contains_my_ip_addr")
    @patch("requests.head")
    def test_validate_graph_ok_no_exception(self, MockRequest, MockContainsIp):
    ...
    def test_validate_graph_graph_not_parsed_throws_exception(self):
        main_activity_attrs, _, _ = helpers.create_main_act_attributes("hospital")
        doc, bundle, _, _, _, _ = helpers.create_cpm_provenance_basic("ex", "hospital", "org",
                                                                      datetime.now().timestamp(), main_activity_attrs)
        data_b64 = base64.b64encode(doc.serialize().encode("utf-8"))
    ...
    def test_validate_graph_graph_no_bundles_throws_exception(self):
    ...
    def test_validate_graph_graph_has_too_many_bundles_throws_exception(self):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/",
                                    self.prov_validator)
        checker._prov_document = provm.ProvDocument()
    ...
    def test_validate_graph_graph_not_resolvable_references_throws_exception(self, MockProcessReferences):
    ...
    def test_validate_graph_graph_nok_backward_connector_attrs_throws_exception(self, MockCheckConnectors):
    ...
    def test_validate_graph_graph_nok_forward_connector_attrs_throws_exception(self, MockCheckForwardConnectors,
    ...
    def test_validate_graph_graph_nok_cpm_constraints_throws_exception(self, MockCheckCPMConstraints, MockProcessReferences,
    ...
    def test_validate_graph_graph_nok_namespaces_throws_exception(self, MockCheckNamespaces, MockCheckCPMConstraints,
    ...
    def test_validate_graph_graph_nok_validity_throws_exception(self, MockCheckValidity, MockCheckNamespaces, MockCheckCPMConstraints,
                                                 MockProcessReferences,
                                                 MockCheckForwardConnectors,
                                                 MockCheckBackwardConnectors):
        MockCheckBackwardConnectors.return_value = True
    ...
    @patch("provenance.validators.contains_my_ip_addr")
    @patch("requests.head")
    def test__check_CPM_constraints_nok_added_second_main_activity_throws_exception(self, MockRequest,
                                                                   MockContainsIp):
        MockContainsIp.return_value = True
        response = Response()
        response.url = "/api/v1/documents/meta/meta_id"
    ...
    def test__check_namespaces_one_defined_ns_ok_returns_true(self):
    ...
    def test__check_namespaces_two_defined_nss_ok_returns_true(self):
        doc = provm.ProvDocument()
        ns = Namespace("def", "http://default#")
        doc.add_namespace(ns)
        doc_bundle = doc.bundle(ns["bundle_identifier"])
    ...
    def test__check_namespaces_entity_without_namespace_returns_false(self):
        doc = provm.ProvDocument()
    ...
    def test__check_namespaces_agent_without_namespace_returns_false(self):
        doc = provm.ProvDocument()
        ns = Namespace("def", "http://def#")
        doc.add_namespace(ns)
        doc_bundle = doc.bundle(ns["bundle_identifier"])
    ...
    def test__check_namespaces_namespace_ends_on_non_special_character_returns_false(self):
        doc = provm.ProvDocument()
        ns = Namespace("def", "http://def")
        doc.add_namespace(ns)
        doc_bundle = doc.bundle(ns["bundle_identifier"])
    ...
    def test_send_signature_verification_request_sends_request_returns_response(self, MockRequests):
        payload = {"id": "id"}
        org_id = "org_id"
    ...
    def test_check_ids_match_ok_no_exception(self):
        checker = InputGraphChecker("", "json",
    ...
    def test_check_ids_match_nok_wrong_bundle_id_throws_exception(self):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
    ...
    def test_check_ids_match_nok_wrong_uri_throws_exception(self):
        checker = InputGraphChecker("", "json",
    ...
    def test__contains_my_ip_addr_ok_returns_true(self):
    ...
    def test__contains_my_ip_addr_nok_returns_false(self):
        my_name_ip = socket.gethostbyname_ex(socket.gethostname())[-1][0]
    ...
    @patch("requests.head")
    def test__check_resolvability_and_retrieve_meta_id_ok_returns_meta_id(self, MockRequest):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
        my_name_ip = socket.gethostbyname_ex(socket.gethostname())[-1][0]
    ...
    @patch("requests.head")
    def test__check_resolvability_and_retrieve_meta_id_nok_missing_meta_bundle_id_throws_exception(self, MockRequest):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
        my_name_ip = socket.gethostbyname_ex(socket.gethostname())[-1][0]
    ...
    @patch("requests.head")
    @patch("provenance.validators.contains_my_ip_addr")
    def test__check_resolvability_and_retrieve_meta_id_nok_meta_bundle_does_not_contain_my_ip_throws_exception(self, MockContainsIp,
                                                                                                   MockRequest):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
    ...
    @patch("requests.head")
    def test__check_resolvability_and_retrieve_meta_id_nok_meta_substring_not_in_meta_uri_throws_exception(self, MockRequest):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
        my_name_ip = socket.gethostbyname_ex(socket.gethostname())[-1][0]
    ...
    def test__retrieve_main_activity_returns_main_activity(self):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
    ...
    def test__retrieve_main_activity_nok_more_main_activities_throws_exception(self):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
        bundle = provm.ProvBundle(identifier=QualifiedName(NAMESPACES["meta"], "test_bundle_id"))
    ...
    def test__retrieve_main_activity_nok_no_main_activities_throws_exception(self):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
        bundle = provm.ProvBundle(identifier=QualifiedName(NAMESPACES["meta"], "test_bundle_id"))
    ...
    def test__retrieve_connectors_from_graph_returns_connectors(self):
        backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector, maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _ = helpers.create_prov_cpm_basic_and_prepare_bundle_referencing_it_with_backward_connector()
    ...
    def test__retrieve_connectors_from_graph_2_decides_depending_on_attributes_returns_connectors(self, MockIsBackbone):
    ...
    @patch("provenance.is_backbone_entity_strategies.IsBackboneStrategyOriginal.is_backbone_element")
    def test__retrieve_connectors_from_graph_2_decides_depending_on_attributes_and_whether_belongs_to_backbone_returns_connectors(self,
                                                                                                               MockIsBackbone):
    ...
    def test_check_connectors_and_hash_no_cpm_attribute_returns_none(self):
        bundle = provm.ProvBundle(identifier=QualifiedName(NAMESPACES["meta"], "test_bundle_id"))
        bundle.add_namespace(
            "my_ns", "http://this_storage:80/api/v1/documens/"
        )
    ...
    @patch("requests.head")
    @patch("requests.get")
    def test_check_connectors_and_hash_all_resolvable_except_hash_returns_responses_and_true(self, MockRequestGet, MockRequestHead):
        bundle = provm.ProvBundle(identifier=QualifiedName(NAMESPACES["meta"], "test_bundle_id"))
        main_act_bundle_ns = bundle.add_namespace(
            "my_ns", "http://this_storage:80/api/v1/documens/"
        )
    ...
    @patch("requests.head")
    @patch("requests.get")
    def test_check_connectors_and_hash_all_resolvable_returns_responses_and_true(self, MockRequestGet, MockRequestHead):
        bundle = provm.ProvBundle(identifier=QualifiedName(NAMESPACES["meta"], "test_bundle_id"))
        main_act_bundle_ns = bundle.add_namespace(
            "my_ns", "http://this_storage:80/api/v1/documens/"
        )
    ...
    @patch("requests.head")
    @patch("requests.get")
    def test_check_connectors_and_hash_all_resolvable_wrong_hash_returns_responses_and_false(self, MockRequestGet, MockRequestHead):
        bundle = provm.ProvBundle(identifier=QualifiedName(NAMESPACES["meta"], "test_bundle_id"))
        main_act_bundle_ns = bundle.add_namespace(
            "my_ns", "http://this_storage:80/api/v1/documens/"
        )
    ...
    @patch("requests.head")
    @patch("requests.get")
    def test_check_connectors_and_hash_all_resolvable_wrong_hash_alg_returns_responses_and_false(self, MockRequestGet, MockRequestHead):
        bundle = provm.ProvBundle(identifier=QualifiedName(NAMESPACES["meta"], "test_bundle_id"))
        main_act_bundle_ns = bundle.add_namespace(
            "my_ns", "http://this_storage:80/api/v1/documens/"
        )
    ...
    @patch("provenance.validators.contains_my_ip_addr")
    def test__process_bundle_references_ok_returns_true(self, MockContainsMyIP, MockPingConnectors):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
        response_get_ok = Response()
    ...
    def test__process_bundle_references_nok_response_returns_false_and_message(self, MockCheckReferences, MockPingConnectors):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
    ...
    @patch("provenance.validators.ping_connectors_and_check_hash")
    @patch("provenance.validators._check_connectors_references")
    def test__process_bundle_references_nok_response_2_returns_false_and_message(self, MockCheckReferences, MockPingConnectors):
        checker = InputGraphChecker("", "json",
                                    "http://provenance-storage-provider.com:8000/api/v1/organizations/UniParis/bundle",
                                    self.prov_validator)
