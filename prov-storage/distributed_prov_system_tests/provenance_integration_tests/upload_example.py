...
# code for testing upload of files created in other thesis
...
class MyTestCase(TestCase):
    ...
    def test_02(self):
        ...
        with open("dataset1/Dataset1_cpm_storage_v0.json", encoding="utf-8", newline="") as file:
            document = file.read()
        ...
        res = requests.post(
            f"http://{provenance_storage_hospital_url}/api/v1/organizations/I2LAH5SF/documents/SamplingBundle_V0",
            json.dumps(json_data))
        print(res.status_code)
        print(res.content.decode("utf-8"))

        with open("dataset2/Dataset2_cpm_storage_v0.json", encoding="utf-8", newline="") as file:
            document = file.read()
        ...
        res = requests.post(
            f"http://{provenance_storage_hospital_url}/api/v1/organizations/I2LAH5SF/documents/ProcessingBundle_V0",
            json.dumps(json_data))
        print(res.status_code)
        print(res.content.decode("utf-8"))

        with open("dataset3/Dataset3_cpm_storage_v0.json", encoding="utf-8", newline="") as file:
            document = file.read()
        ...
        res = requests.post(
            f"http://{provenance_storage_hospital_url}/api/v1/organizations/I2LAH5SF/documents/SpeciesIdentificationBundle_V0",
            json.dumps(json_data))
        print(res.status_code)
        print(res.content.decode("utf-8"))

        with open("dataset4/Dataset4_cpm_storage_v0.json", encoding="utf-8", newline="") as file:
            document = file.read()
        ...
        with open("dataset1/Dataset1_cpm_storage_v1.json", encoding="utf-8", newline="") as file:
            document = file.read()
        ...
        with open("dataset2/Dataset2_cpm_storage_v1.json", encoding="utf-8", newline="") as file:
            document = file.read()
