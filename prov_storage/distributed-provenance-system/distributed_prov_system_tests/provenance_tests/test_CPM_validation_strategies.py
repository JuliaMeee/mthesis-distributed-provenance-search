...
from prov.model import ProvBundle, first, ProvActivity, ProvUsage, ProvGeneration, ProvAttribution, ProvInfluence, \
    ProvAgent, ProvEntity, ProvSpecialization, ProvDerivation, ProvDocument

import helpers
from CPM_validation_strategies import CPMValidatorFirst
from constants import CPM_MAIN_ACTIVITY, CPM_BACKWARD_CONNECTOR, CPM_REFERENCED_BUNDLE_ID, \
...
class MyTestCase(TestCase):
    ...
    def test__check_CPM_constraints_nok_added_connector_between_backbone_and_ds(self):
    ...
    def test__check_CPM_constraints_nok_added_relation_to_main_activity_generation_of_not_forward_connector(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_added_relation_to_main_activity_usage_of_not_backward_connector(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_backwards_connector_connected_to_same_bundle(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info,
         remote_meta_bundle_namespace) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_missing_relation_to_main_activity_from_backward_connector(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_backward_connectors_ok(self):
        result = self.CPM_validator.check_backward_connectors_attributes([x for x in self.backbone_parts2 if
                                                                          CPM_BACKWARD_CONNECTOR in x.get_asserted_types()])
        self.assertTrue(result)

    def test__check_backward_connectors_nok_CPM_REFERENCED_BUNDLE_ID_missing(self):
        backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector, maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _ = helpers.create_prov_cpm_basic()
    ...
    def test__check_backward_connectors_nok_CPM_REFERENCED_META_BUNDLE_ID_missing(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_backward_connectors_nok_CPM_REFERENCED_BUNDLE_HASH_VALUE_missing(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_backward_connectors_nok_CPM_HASH_ALG_missing(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_forward_connectors_ok(self):
    ...
    def test__check_forward_connectors_ok_2(self):
        storage_name = "provider"
        org_name = "org"
    ...
    def test__check_forward_connectors_nok_CPM_REFERENCED_BUNDLE_ID_missing(self):
        storage_name = "provider"
        org_name = "org"
    ...
    def test__check_forward_connectors_nok_CPM_REFERENCED_META_BUNDLE_ID_missing(self):
        storage_name = "provider"
        org_name = "org"
    ...
    def test__check_forward_connectors_nok_CPM_REFERENCED_BUNDLE_HASH_VALUE_missing(self):
        storage_name = "provider"
        org_name = "org"
    ...
    def test__check_forward_connectors_nok_CPM_HASH_ALG_missing(self):
        storage_name = "provider"
        org_name = "org"
    ...
    def test__check_CPM_constraints_ok_1(self):
        storage_name = "provider"
        org_name = "org"
    ...
    def test__check_CPM_constraints_nok_missing_relation_to_main_activity_from_forward_connector(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_derivation_of_backward_connector_from_entity_from_domain(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_missing_relation_to_sender_agent_from_backward_connector(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_missing_sender_agent_for_backward_connector(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_missing_relation_to_receiver_agent_from_specialized_forward_connector(self):
    ...
    def test__check_CPM_constraints_nok_derivation_of_forward_connector_from_not_connector(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_derivation_of_backward_connector_from_not_connector(self):
        (backward_connector_attributes, bundle_with_backwards_conn, document_with_backwards_connector,
         maa2, prev_cpm_bundle_info, prev_meta_bundle_info, _) = helpers.create_prov_cpm_basic()
    ...
    def test__check_CPM_constraints_nok_specialization_between_concrete_and_general_forward_connector_missing(self):
        main_activity_attributes_ok, main_act_attr2, timestamp = create_main_act_attributes("hospital")
    ...
    def test__check_CPM_constraints_nok_derivation_between_first_and_redundant_forward_connector_missing(self):
        main_activity_attributes_ok, main_act_attr2, timestamp = create_main_act_attributes("hospital")
    ...
    def test__check_CPM_constraints_nok_derivation_between_first_and_redundant_backward_connector_missing(self):
        main_activity_attributes_ok, main_act_attr2, timestamp = create_main_act_attributes("hospital")
    ...
    def test__check_CPM_constraints_nok_derivation_of_redundant_forward_connector_from_domain_entity(self):
        main_activity_attributes_ok, main_act_attr2, timestamp = create_main_act_attributes("hospital")
    ...
    def test__check_CPM_constraints_nok_generation_of_forward_connector_by_main_activity_and_other_activity(self):
        main_activity_attributes_ok, main_act_attr2, timestamp = create_main_act_attributes("hospital")
    ...
    def test__check_CPM_constraints_nok_generation_of_forward_connector_by_not_main_activity(self):
        main_activity_attributes_ok, main_act_attr2, timestamp = create_main_act_attributes("hospital")
    ...
    def test__check_CPM_constraints_nok_connector_references_bundle(self):
        main_activity_attributes_ok, main_act_attr2, timestamp = create_main_act_attributes("hospital")
    ...
    def test__check_CPM_constraints_nok_connector_references_meta_bundle(self):
        main_activity_attributes_ok, main_act_attr2, timestamp = create_main_act_attributes("hospital")
