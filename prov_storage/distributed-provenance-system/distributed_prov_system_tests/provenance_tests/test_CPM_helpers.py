...
from CPM_helpers import get_prov_generations_usages_attributions_agents, get_backbone_and_domain, has_any_cpm_type, \
    contains_non_backbone_attribute, relation_belongs_to_bb
from constants import CPM_SENDER_AGENT, CPM_RECEIVER_AGENT, CPM_BACKWARD_CONNECTOR, CPM_FORWARD_CONNECTOR, \
...
class MyTestCase(TestCase):
    ...
    def test_get_prov_generations_usages_attributions_agents(self):
        ...
        generations, usages, attributions, sender_agents, receiver_agents,_, derivations, all_relations = get_prov_generations_usages_attributions_agents(
            bundle)
        ...
        self.assertEqual([geenration, usage, attribution, attribution2], all_relations)

    def test_get_backbone_and_domain(self):
    ...
    def test_relation_belongs_to_bb_true_usage(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.activity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_influence(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.activity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_communication(self):
        bundle = create_basic_bundle()
    ...
    def test_relation_belongs_to_bb_true_alternate(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_start(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.activity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_end(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.activity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_invalidation(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.activity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_attribution(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_association(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.activity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_delegation(self):
        bundle = create_basic_bundle()
    ...
    def test_relation_belongs_to_bb_true_specialization(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.entity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_mention(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.entity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_true_membership(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.entity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_false(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.entity(identifier="my_ns:ent_id", other_attributes={})
    ...
    def test_relation_belongs_to_bb_false_2(self):
        bundle = create_basic_bundle()
        record1 = bundle.entity(identifier="my_ns:id", other_attributes={})
        record2 = bundle.entity(identifier="my_ns:ent_id", other_attributes={})
        membership = bundle.membership(record1, record2)
