...
from constants import CPM_REFERENCED_BUNDLE_HASH_VALUE, CPM_HASH_ALG
...
class MyTestCase(TestCase):
    ...
    def test_get_provenance_exists(self, MockDocumentNodes):
    ...
    @patch('provenance.models.Document.nodes')
    def test_query_db_for_subgraph(self, MockDocumentNodes):
        neo_document = Document()
        neo_document.identifier = "neo_doc"
        ...
        graph_returned, token_returned = query_db_for_subgraph("org_id", "graph_id", False, "json")
    ...
    def test_query_db_for_subgraph_no_token(self, ConfigDisable, MockDocumentNodes):
        neo_document = Document()
        neo_document.identifier = "neo_doc"
        neo_document.format = "json"
        neo_document.graph = "json_graph..."
    ...
    def test_get_token_to_store_into_db(self, MockTrustedPartyNodes, MockDocumentNodes):
        neo_document = Document()
        neo_document.identifier = "neo_doc"
        neo_document.format = "json"
        neo_document.graph = "json_graph..."
    ...
    def test_store_subgraph_into_db(self, MockDb, MockDocument):
    ...
    def test_store_token_into_db(self):
    ...
    def test_get_b64_encoded_subgraph(self, MockRetrieve_subgraph, MockDocumentNodes):
    ...
    @patch('provenance.controller.db')
    def test_get_token(self, MockDb, MockIs_org_registered):
        document = Document(identifier="doc_id")
    ...
    @patch('provenance.controller.is_org_registered')
    @patch('provenance.controller.db')
    def test_get_token_rg_not_registered(self, MockDb, MockIs_org_registered):
        document = Document(identifier="doc_id")
    ...
    def test_get_token_token_not_in_db(self, MockStoreToken, MockGetTokenToStore, MockTokenRequest, MockGetOrg, MockDb,
    ...
    def test_get_b64_encoded_meta_provenance(self, MockConvertToProv, MockBundle):
        meta_id = "prov:meta_1"
    ...
    def test_retrieve_subgraph_domain_specific(self):
    ...
    def test_retrieve_subgraph_domain_specific_2(self):
        storage_name = "provider"
        org_name = "org"
    ...
    def test_retrieve_subgraph_backbone(self):
    ...
    def test_retrieve_subgraph_backbone_2(self):
        storage_name = "provider"
        org_name = "org"
    ...
    @patch('provenance.controller.db')
    def test_create_organization(self, MockDb, MockStoreOrg, GetTpMock):
        org_id = "ORG"
    ...
    @patch('provenance.models.Document.nodes')
    def test_bundle_exists_true(self, MockDocumentNodes):
        id = "id"
    ...
    @patch('provenance.models.Document.nodes')
    def test_bundle_exists_false(self, MockDocumentNodes):
        id = "id"
        MockDocumentNodes.get_or_none = MagicMock()
    ...
    @patch('provenance.models.Bundle.nodes')
    def test_meta_bundle_exists_true(self, MockDocumentNodes):
        id = "id"
        MockDocumentNodes.get_or_none = MagicMock()
    ...
    @patch('provenance.models.Bundle.nodes')
    def test_meta_bundle_exists_false(self, MockDocumentNodes):
        id = "id"
        MockDocumentNodes.get_or_none = MagicMock()
        MockDocumentNodes.get_or_none.return_value = None
        exists = meta_bundle_exists(id)
    ...
    def test__verify_at_local_storage_exists(self, MockMetaBundleExists, MockBundleExists):
    ...
    @patch('provenance.controller.bundle_exists')
    @patch('provenance.controller.meta_bundle_exists')
    def test__verify_at_local_storage_not_exists(self, MockMetaBundleExists, MockBundleExists):
        referenced_bundle_id = QualifiedName(Namespace("org", "http://www.w3.org/organizations/org_id/end"),
                                             "bundle_id")
        referenced_meta_bundle_id = QualifiedName(NAMESPACES["meta"], "meta_bundle_id")
    ...
    def test__referenced_bundles_exist_remote(self, MockVerifyRemote):
    ...
    def test__referenced_bundles_exist_local(self, MockVerifyLocal):
        bundle = ProvBundle(identifier="bundle")
        connector = ProvRecord(bundle, "id")
        connector._attributes = {CPM_REFERENCED_BUNDLE_ID: [
            QualifiedName(Namespace("org", "http://www.w3.org/organizations/org_id/end"), "bundle_id")],
    ...
    def test__check_referenced_bundles_notOK(self, MockBundlesExist):
    ...
    @patch('provenance.controller._referenced_bundles_exist')
    def test__check_referenced_bundles_OK(self, MockBundlesExist):
        connectors = [["", "connector1"], ["url...", "connector2"]]
    ...
    @patch('provenance.controller.store_organization')
    @patch('provenance.controller.db')
    def test_modify_organization(self, MockDb, MockStoreOrg, MockOrgNodes, MockGetTP):
        org = Organization()
    ...
    @patch('provenance.models.Organization.nodes')
    def test_get_tp_url_by_organization(self, MockOrgNodes):
        org = MagicMock()
    ...
    def test_get_tp_url_by_organization_does_not_exist(self, MockDoesnotExist, MockOrgNodes):
        MockOrgNodes.get = MagicMock()
    ...
    def test_send_token_request_to_tp_ok(self, MockRequests):
    ...
    @patch('provenance.controller.requests')
    def test_send_token_request_to_tp_not_ok(self, MockRequests):
        payload = {"something": "value"}
        MockRequests.post = MagicMock()
        MockRequests.post.return_value = requests.Response()
    ...
    @patch('provenance.models.TrustedParty.nodes')
    def test_get_tp_no_url_saved_tp(self, MockTrustedPartyNodes, MockDefaultTrustedPartyNodesGet):
    ...
    @patch('provenance.models.DefaultTrustedParty.nodes')
    @patch('provenance.models.TrustedParty.nodes')
    def test_get_tp_no_url_saved_tp_nok(self, MockTrustedPartyNodes, MockDefaultTrustedPartyNodesGet):
        mock_default_tp = MagicMock()
        mock_default_tp.identifier = "tp_id"
    ...
    @patch('provenance.models.TrustedParty.nodes')
    @patch('provenance.controller.requests')
    def test_get_tp_url_saved_tp_ok(self, MockRequests, MockTrustedPartyNodes):
    ...
    @patch('provenance.models.TrustedParty.nodes')
    @patch('provenance.controller.requests')
    def test_get_tp_url_saved_tp_nok(self, MockRequests, MockTrustedPartyNodes):
        trusted_party = {"id": "tp_id"}
        MockRequests.get = MagicMock()
        MockRequests.get.return_value = requests.Response()
    ...
    @patch('provenance.controller.requests')
    @patch('neomodel.exceptions.DoesNotExist._model_class', return_value='c')
    def test_get_tp_url_new_tp_ok(self, MockDoesNotExist, MockRequests, MockTrustedPartyNodes):
