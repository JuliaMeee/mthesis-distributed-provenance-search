...
class MyTestCase(TestCase):
    ...
    def test_1393_edit_graph_with_basic_backbone_nok_backward_connector_cycle(
        ...
        helpers.add_backward_connector(
            backward_connector_attributes, bundle_updated_2_nok, existential_variable_generator, main_activity,
    ...
    def test_1500_store_graph_with_backbone_end_update_nok_two_backward_connectors_derivation_relation(
            self):
        # prepare fresh document same way as for ok data - to not change the right one because of other tests
    ...
    def create_main_activity_attributes(self, id_suffix="", meta_ns=prov_data.meta_ns_pathology):
        main_activity_attributes_2 = {
            PROV_TYPE: CPM_MAIN_ACTIVITY,
            CPM_REFERENCED_META_BUNDLE_ID: meta_ns[
                f"test_{self.prov_data.timestamp}_bundle_meta{id_suffix}"
            ],
        }
        return main_activity_attributes_2
