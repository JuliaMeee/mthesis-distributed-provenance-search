...
class ControllerTestCase(TestCase):
    ...
    def test_retrieve_organizations_ok(self):
    ...
    def test_get_sorted_certificates(self):
    ...
    def test_verify_chain_of_trust_ok(self):
    ...
    def test_verify_chain_of_trust_nok(self):
        with open('certificates/uni_graz/uni_graz.pem', 'r') as file:
            client_cert = file.read()
        with open('certificates/uni_graz/intermediate_1.pem', 'r') as file:
            intermediate_cert_1 = file.read()
    ...
    def test_revoke_all_stored_certificates(self):
    ...
    def test_retrieve_tokens(self):
        ...
        with open('C:/skola/diplomka/certs/cert.pem', 'r') as file:
            my_cert = file.read()
    ...
    def test_retrieve_specific_token_exist(self):
    ...
    def test_retrieve_specific_token_does_not_exist(self):
        self.assertRaises(Document.DoesNotExist, retrieve_specific_token,"org1", "id", "graph")

    def test_retrieve_specific_multiple_tokens_exist(self):
    ...
    def test_verify_signature_nok_throws_error(self):
        with open('C:/skola/diplomka/certs/cert.pem', 'r') as file:
            client_cert = file.read()
    ...
    def test_get_serialized_token(self):
        json_data = {}
        json_data["organizationId"] = "uni_graz"
        json_data["document"] = base64.b64encode("graph".encode('utf-8'))
    ...
    def test_check_is_subgraph_ok(self):
    ...
    def test_check_is_subgraph_nok_namespace(self):
        prov_bundle = ProvBundle()
        prov_bundle_original = ProvBundle()
    ...
    def test_check_is_subgraph_nok_added_entity(self):
        prov_bundle = ProvBundle()
        prov_bundle_original = ProvBundle()
    ...
    def test_check_is_subgraph_nok_added_activity(self):
        prov_bundle = ProvBundle()
        prov_bundle_original = ProvBundle()
    ...
    def test_check_is_subgraph_nok_added_relation(self):
        prov_bundle = ProvBundle()
        prov_bundle_original = ProvBundle()
    ...
    def test_issue_token_and_store_doc_graph_ok(self):
    ...
    def test_issue_token_and_store_doc_meta_ok(self):
        with open('01_sample_acquisition.json', 'r') as file:
            graph = file.read()
    ...
    def test_issue_token_and_store_doc_backbone_ok(self):
        with open('01_sample_acquisition.json', 'r') as file:
            graph = file.read()
