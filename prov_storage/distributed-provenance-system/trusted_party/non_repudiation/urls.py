...
urlpatterns = [
    ...
    path("organizations/<org_id>/documents/<path:doc_id>/<path:doc_format>", views.retrieve_document, name="dokument_retrieval"),
    # fix - path:
    path("organizations/<org_id>/tokens/<path:doc_id>/<path:doc_format>", views.specific_token, name="token_retrieval"),
